---
name: adr-critique
description: This skill should be used when the user wants to audit an existing or legacy Architecture Decision Record — one that predates this plugin, was imported from another team, was generated by generic LLM tooling, or is part of a corpus-wide quality sweep. PROACTIVELY activate on phrases like "review this ADR," "critique this ADR," "audit our decision log," "is this ADR any good?", "fix this old ADR," "rewrite this legacy ADR," "our ADRs are full of filler," "ADR cleanup," "ADR quality sweep," "tighten this ADR," "score these ADRs," "this ADR is too long." Catches filler, hedging, implementation detail bleed, missing-why, inconsistency with neighboring ADRs, and drift between ADRs and LikeC4 models. Line-by-line, quotes-verbatim, requires per-line architect approval. Skip this skill for ADRs already self-critiqued by `adr-drafting` — use it specifically for ADRs that did NOT go through that flow.
---
