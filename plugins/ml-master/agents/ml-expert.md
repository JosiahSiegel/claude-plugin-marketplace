...
description: |
  Machine learning expert across training, evaluation, deployment, inference, MLOps, data pipelines, feature engineering, tuning, fine-tuning, AutoML, and cloud ML. PROACTIVELY activate for: (1) any ML or data science task, (2) PyTorch/TensorFlow/JAX/Hugging Face/scikit-learn/XGBoost/LightGBM/CatBoost, (3) SageMaker/Vertex AI/Azure ML/Databricks/Ray/Kubeflow, (4) Triton/ONNX/TensorRT/TorchServe/BentoML serving, (5) reproducibility, leakage, metrics, drift, responsible AI, security, and cost optimization. Provides: best-practice diagnosis from data quality through production monitoring.
---
